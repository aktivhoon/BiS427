...
Neuron_Response=Response(1,90,Degree_Range);    % Obtain the neural response for the case where theta_p = 90
...
Neural_Response=Response(1,theta_p,Direction);  % Obtain the neural response ([cos(theta-theta_p)]+)
...
hold off;
title('Angle Prediction of the [cos(\theta-\theta_p)]_+ function','FontSize',14);
